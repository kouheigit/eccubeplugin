...
// Returns the public 'Eccube\Controller\Block\CalendarController' shared autowired service.
...
$this->services['Eccube\\Controller\\Block\\CalendarController'] = $instance = new \Eccube\Controller\Block\CalendarController(($this->privates['Eccube\\Repository\\CalendarRepository'] ?? $this->load('getCalendarRepositoryService.php')));
