...
$this->services['Eccube\\Controller\\Admin\\Product\\TagController'] = $instance = new \Eccube\Controller\Admin\Product\TagController(($this->privates['Eccube\\Repository\\TagRepository'] ?? $this->load('getTagRepositoryService.php')));
