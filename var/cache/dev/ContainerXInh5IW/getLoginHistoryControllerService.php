...
// Returns the public 'Eccube\Controller\Admin\Setting\System\LoginHistoryController' shared autowired service.
...
$this->services['Eccube\\Controller\\Admin\\Setting\\System\\LoginHistoryController'] = $instance = new \Eccube\Controller\Admin\Setting\System\LoginHistoryController(($this->privates['Eccube\\Repository\\Master\\PageMaxRepository'] ?? $this->load('getPageMaxRepositoryService.php')), ($this->privates['Eccube\\Repository\\LoginHistoryRepository'] ?? $this->load('getLoginHistoryRepositoryService.php')));
