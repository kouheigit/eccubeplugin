...
$this->services['Eccube\\Controller\\Admin\\Setting\\Shop\\MailController'] = $instance = new \Eccube\Controller\Admin\Setting\Shop\MailController(($this->privates['Eccube\\Repository\\MailTemplateRepository'] ?? $this->load('getMailTemplateRepositoryService.php')));
