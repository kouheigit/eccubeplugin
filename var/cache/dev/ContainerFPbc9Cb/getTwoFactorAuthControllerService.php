...
$this->services['Eccube\\Controller\\Admin\\Setting\\System\\TwoFactorAuthController'] = $instance = new \Eccube\Controller\Admin\Setting\System\TwoFactorAuthController(($this->privates['security.encoder_factory.generic'] ?? $this->getSecurity_EncoderFactory_GenericService()), ($this->privates['Eccube\\Repository\\MemberRepository'] ?? $this->load('getMemberRepositoryService.php')), ($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->privates['Eccube\\Service\\TwoFactorAuthService'] ?? $this->getTwoFactorAuthServiceService()));
