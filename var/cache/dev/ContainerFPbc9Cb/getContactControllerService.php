...
$this->services['Eccube\\Controller\\ContactController'] = $instance = new \Eccube\Controller\ContactController(($this->privates['Eccube\\Service\\MailService'] ?? $this->load('getMailServiceService.php')), ($this->privates['Eccube\\Repository\\PageRepository'] ?? $this->getPageRepositoryService()));
