...
$this->services['Eccube\\Controller\\Admin\\Content\\BlockController'] = $instance = new \Eccube\Controller\Admin\Content\BlockController(($this->privates['Eccube\\Repository\\BlockRepository'] ?? $this->getBlockRepositoryService()), ($this->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? $this->getDeviceTypeRepositoryService()));
