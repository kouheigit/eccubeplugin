...
$this->services['Eccube\\Controller\\Admin\\Product\\ProductClassController'] = $instance = new \Eccube\Controller\Admin\Product\ProductClassController(($this->privates['Eccube\\Repository\\ProductRepository'] ?? $this->getProductRepositoryService()), ($this->privates['Eccube\\Repository\\ProductClassRepository'] ?? $this->getProductClassRepositoryService()), ($this->privates['Eccube\\Repository\\ClassCategoryRepository'] ?? $this->load('getClassCategoryRepositoryService.php')), ($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()), ($this->privates['Eccube\\Repository\\TaxRuleRepository'] ?? $this->getTaxRuleRepositoryService()));
