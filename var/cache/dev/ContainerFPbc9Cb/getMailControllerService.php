...
$this->services['Eccube\\Controller\\Admin\\Order\\MailController'] = $instance = new \Eccube\Controller\Admin\Order\MailController(($this->privates['Eccube\\Service\\MailService'] ?? $this->load('getMailServiceService.php')), ($this->privates['Eccube\\Repository\\MailHistoryRepository'] ?? $this->load('getMailHistoryRepositoryService.php')), ($this->privates['Eccube\\Repository\\OrderRepository'] ?? $this->getOrderRepositoryService()), ($this->services['twig'] ?? $this->getTwigService()));
