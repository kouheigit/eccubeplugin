...
$this->services['Eccube\\Controller\\Admin\\Content\\NewsController'] = $instance = new \Eccube\Controller\Admin\Content\NewsController(($this->privates['Eccube\\Repository\\NewsRepository'] ?? $this->load('getNewsRepositoryService.php')));
