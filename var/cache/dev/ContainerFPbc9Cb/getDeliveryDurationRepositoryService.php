...
return $this->privates['Eccube\\Repository\\DeliveryDurationRepository'] = new \Eccube\Repository\DeliveryDurationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
