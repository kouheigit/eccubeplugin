...
$this->services['Eccube\\Controller\\Admin\\Product\\ClassCategoryController'] = $instance = new \Eccube\Controller\Admin\Product\ClassCategoryController(($this->privates['Eccube\\Repository\\ProductClassRepository'] ?? $this->getProductClassRepositoryService()), ($this->privates['Eccube\\Repository\\ClassCategoryRepository'] ?? $this->load('getClassCategoryRepositoryService.php')), ($this->privates['Eccube\\Repository\\ClassNameRepository'] ?? $this->load('getClassNameRepositoryService.php')));
