...
$this->services['Eccube\\Controller\\Admin\\Setting\\Shop\\ShopController'] = $instance = new \Eccube\Controller\Admin\Setting\Shop\ShopController(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()));
