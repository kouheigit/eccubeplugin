...
$this->services['Eccube\\Controller\\UserDataController'] = $instance = new \Eccube\Controller\UserDataController(($this->privates['Eccube\\Repository\\PageRepository'] ?? $this->getPageRepositoryService()), ($this->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? $this->getDeviceTypeRepositoryService()));
